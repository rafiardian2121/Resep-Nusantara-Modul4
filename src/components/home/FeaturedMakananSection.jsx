...
export default function FeaturedMakananSection({ featuredMakanan, onSelectRecipe, isFavorite, toggleFavorite }) {
    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
        {featuredMakanan.map((recipe, index) => (
          ...
          >
            <div
              onClick={() => onSelectRecipe('makanan', recipe)}
            ...
            >
              ...
              <div className="relative h-32 md:h-56 overflow-hidden">
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    toggleFavorite(`makanan-${recipe.id}`, {
                      id: recipe.id,
                      name: recipe.name,
                ...
                >
                  <Heart className={`w-5 h-5 ${isFavorite(`makanan-${recipe.id}`) ? 'text-red-500 fill-red-500' : 'text-slate-600'}`} />
                </button>
              </div>
